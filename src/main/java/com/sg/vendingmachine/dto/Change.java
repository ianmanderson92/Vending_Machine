...
public class Change
{
    ...
    /**
     Takes in an int that represents the amount of change to dispense.  It calculated the amount of each type of coin to
     be dispensed and then prints the amount of each coin to the user.  Uses the Denomination ENUM to calculate these
     values.
